    ...
    return <div id="Contact" data-aos="fade-right">
        <div className="FullScreen">
            ...
            <div style={{width:"340px",margin:"auto",lineHeight:"60px",paddingTop:"20px"}}>
                <Link href="https://linkedin.com/in/amar-deep-8359aa246/" _hover={{textDecor:"none"}} target="_blank"><Flex className="hover" pl="35px" pr="20px" pb="25px" alignItems="center">
                    <GrLinkedin size="40px"/>
                    <Spacer />
                    <Text fontSize="x-large">Linked in</Text>
                </Flex></Link>
                <Link href="https://github.com/AMARDEEP115" _hover={{textDecor:"none"}} target="_blank"><Flex className="hover" pl="35px" pr="20px" pb="25px" alignItems="center">
                    <FaGithub size="40px"/>
                    <Spacer />
                    <Text fontSize="x-large">Github</Text>
                </Flex></Link>
                <Link href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=amar1998deep@gmail.com" _hover={{textDecor:"none"}} target="_blank"><Flex className="hover" pl="35px" pr="20px" pb="25px" alignItems="center" >
        ...
        <div className="MediumScreen">
            ...
            <div style={{width:"290px",margin:"auto",lineHeight:"60px",paddingTop:"20px"}}>
                <Link href="https://linkedin.com/in/amar-deep-8359aa246/" _hover={{textDecor:"none"}} target="_blank"><Flex className="hover" pl="50px" pr="35px" pb="25px" alignItems="center">
                    <GrLinkedin size="30px"/>
                    <Spacer />
                    <Text fontSize="larger" fontWeight="bold">Linked in</Text>
                </Flex></Link>
                <Link href="https://github.com/AMARDEEP115" _hover={{textDecor:"none"}} target="_blank"><Flex className="hover" pl="50px" pr="35px" pb="25px" alignItems="center">
                    <FaGithub size="30px"/>
                    <Spacer />
        ...
        <div className="SmallScreen">
            ...
            <div style={{width:"230px",margin:"auto",lineHeight:"60px",paddingTop:"20px"}}>
                <Link href="https://linkedin.com/in/amar-deep-8359aa246/" _hover={{textDecor:"none"}} target="_blank"><Flex className="hover" pl="55px" pr="40px" pb="25px" alignItems="center">
                    <GrLinkedin size="20px"/>
                    <Spacer />
                    <Text fontSize="medium">Linked in</Text>
                </Flex></Link>
                <Link href="https://github.com/AMARDEEP115" _hover={{textDecor:"none"}} target="_blank"><Flex className="hover" pl="55px" pr="40px" pb="25px" alignItems="center">
                    <FaGithub size="20px"/>
                    <Spacer />
                    <Text fontSize="medium">Github</Text>
                </Flex></Link>
                <Link href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=amar1998deep@gmail.com" _hover={{textDecor:"none"}} target="_blank"><Flex className="hover" pl="30px" pr="10px" pb="25px" alignItems="center" >
