...
function Projects(){
    return <div id="Projects" data-aos="fade-right" style={{marginBottom:"50px",marginTop:"70px"}}>
        <h1 style={{fontSize:"50px",textAlign:"center",marginBottom:"25px",color:"yellowgreen"}}>Projects</h1>
